...
func CmdStart(args []string) error {
	...
	fs.Usage = func() {
		...
		fmt.Fprintf(os.Stderr, "  # Start in background (daemon mode)\n")
		fmt.Fprintf(os.Stderr, "  opencode-tmux start mysession --daemon\n\n")
		fmt.Fprintf(os.Stderr, "  # Start daemon without attaching (two-step workflow)\n")
